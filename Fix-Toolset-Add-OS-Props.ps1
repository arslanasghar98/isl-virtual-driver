# Fix-Toolset-Add-OS-Props.ps1
# Add WindowsDriver.OS.Props import to set Valid_NTTARGETVERSIONS

#Requires -RunAsAdministrator

Write-Host "===========================================================" -ForegroundColor Cyan
Write-Host "Adding WindowsDriver.OS.Props Import" -ForegroundColor Cyan
Write-Host "===========================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "This file sets Valid_NTTARGETVERSIONS based on TargetPlatformVersion" -ForegroundColor Yellow
Write-Host ""
...
# Complete Toolset.props with OS.Props import
$propsContent = @'
...
Write-Host "The Toolset.props now imports WindowsDriver.OS.Props" -ForegroundColor Green
Write-Host "which sets Valid_NTTARGETVERSIONS for build validation." -ForegroundColor Green
Write-Host ""
